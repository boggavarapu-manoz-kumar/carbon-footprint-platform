...
const OrganizationLayout = () => {
  ...
  const { t } = useTranslation();
    ...
    const navItems = [
    { name: t('sidebar.overview', 'Overview'), path: `/organization/${orgId}`, icon: HomeIcon, exact: true },
    { name: t('sidebar.members', 'Members'), path: `/organization/${orgId}/members`, icon: UserIcon },
    { name: t('sidebar.invitations', 'Invitations'), path: `/organization/${orgId}/invitations`, icon: MessageIcon },
    { name: t('sidebar.analytics', 'Analytics'), path: `/organization/${orgId}/analytics`, icon: BarChartIcon },
    { name: t('sidebar.reports', 'Reports'), path: `/organization/${orgId}/reports`, icon: ListIcon },
    { name: t('sidebar.settings', 'Settings'), path: `/organization/${orgId}/settings`, icon: SettingsIcon },
  ];
